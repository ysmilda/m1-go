...
func (p *Procedures) ListProcessValueInfo(module res.ModuleNumber, c *ListProcessValueInfoCall, stepSize uint32) ([]ProcessValueInfo, error) {
	return rpc.ListCall(p.client, rpc.Module{Number: module.ModuleNumber, Port: module.Port}, rpc.NewListProcedure[ProcessValueInfo, *ListProcessValueInfoCall, *ListProcessValueInfoReply](10014, rpc.VersionDefault, c), stepSize)
}

func (p *Procedures) ListExtendedProcessValueInfo(module res.ModuleNumber, c *ListExtendedProcessValueInfoCall, stepSize uint32) ([]ExtendedProcessValueInfo, error) {
	c.extendedCallIdentifier = PvInfoExtendedCallIdentifier
	return rpc.ListCall(p.client, rpc.Module{Number: module.ModuleNumber, Port: module.Port}, rpc.NewListProcedure[ExtendedProcessValueInfo, *ListExtendedProcessValueInfoCall, *ListExtendedProcessValueInfoReply](10014, rpc.VersionDefault, c), stepSize)
}
